...
#1
ref_src = cv2.imread('../../img/shapes.png')
...
test_src = cv2.imread('../../img/shapes.png') # testShapes1.jpg
## test_src = cv2.imread('../../img/shapes.png') # testShapes2.jpg
## test_src = cv2.imread('../../img/shapes.png') # testShapes3.jpg
