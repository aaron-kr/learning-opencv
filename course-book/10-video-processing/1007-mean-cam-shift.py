...
while True:
    ...
    if mouse_status == 3:
        ...
        track_win1 = (x1,y1,x2-x1,y2-y1) # meanShift
        track_win2 = (x1,y1,x2-x1,y2-y1) # CamShift
        tracking_start = True
    ...
    if tracking_start:
        ...
        ret, track_win1 = cv2.meanShift(backP, track_win1, term_crit)
        x,y,w,h = track_win1
        cv2.rectangle(frame, (x,y), (x+w,y+h), (0,0,255), 2)

        #3-6: CamShift tracking
        track_box, track_win2 = cv2.CamShift(backP, track_win2, term_crit)
        x,y,w,h = track_win2
