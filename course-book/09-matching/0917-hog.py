...
hog2 = cv2.HOGDescriptor(winSize, blockSize, blockStride, cellSize, nbins, derivAperture, winSigma, histogramNormType, L2HysThreshold, gammaCorrection, nlevels, signedGradient)
...
plt.plot(des1[::36], color = 'r', linewidth = 2, label = 'des2')
plt.plot(des1[::36], color = 'g', linewidth = 1, label = 'des3')
plt.legend(loc = 'best')
plt.show()